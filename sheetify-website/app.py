...
local_path = "/code/models/2004-2006-2008-2009-2011-2013-allsplits-onf.keras"
...
st.markdown("<h2 style='color: #0F172A; font-weight:700;'>🎹 Sheetify &mdash; Audio to Sheet Music</h2>", unsafe_allow_html=True)
